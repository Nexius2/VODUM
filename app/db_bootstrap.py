        ...
        if comm_h_count == 0:
            ...
            if table_exists(cursor, "sent_emails"):
                ...
                for user_id, template_type, expiration_date, sent_at in cursor.fetchall() or []:
                    ...
                    cursor.execute(
                        "INSERT INTO comm_history(kind, template_id, user_id, channel_used, status, error, sent_at, meta_json) VALUES('template', ?, ?, 'email', 'sent', NULL, COALESCE(?, CURRENT_TIMESTAMP), ?)",
